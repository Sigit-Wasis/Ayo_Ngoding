...
class BarangStoreRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'satuan_barang.required' => 'Satuan Barang Harus Diisi Alias Wajibe',
            ...
            'gambar_barang.required' => 'Gambar Barang Harus Diisi Alias Wajibe',
            'gambar_barang.mimes' => 'Gambar Barang Format Harus png, jpg, jpeg',
            'gambar_barang.max' => 'Gambar Barang Maximal 2 MB',
            'harga_barang.required' => 'Harga Barang Harus Diisi Alias Wajibe'
        ];
    }
}
