...
<body>
    <div class="content">
        ...
        <div style="margin-top: 50px;" class="marginleft">
            <table>
                <tr>
                    <td>Nama Sekolah</td>
                    <td>:</td>
                    <Strong>SD ISLAM BENTAKWA</strong>
            ...
            <p><strong>NIS : </strong><strong>08123</strong></p>
            <p style="margin-top: -10px;"><strong>NSS :</strong> <strong>0812345</strong></p>
            <p style="margin-top: 10px;">Sertifikat ini berlaku sejak tanggal di tetapkan sampai tanggal 31 Oktober 2026 dan apabila terdapat kekeliruan di perbaiki sebagaimana mestinya.</p>
        </div>
        ...
        <div class="card">
            <div class="center-image">
                <p style="margin-top: 0px;">Sukadana, 31 Oktober 2023</p>
                <p style="margin-top: 0px;">KEPALA DINAS PENDIDIKAN DAN KEBUDAYAAN KABUPATEN LAMPUNG TIMUR</p><br><br>
                <div style="margin-top: 30px;" class=" judul">ANOM, S.Kom</div>
                <p style="margin-top: 0px;">Pembina Utama Muda</p>
                <p style="margin-top: -20px;">NIP. 012345290902</p>
            </div>
        </div>
    </div>
</body>
