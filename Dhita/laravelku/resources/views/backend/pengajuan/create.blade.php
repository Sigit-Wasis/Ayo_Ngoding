    ...
    <section class="content">
        ...
        <form method="POST" action="{{ route('store_pengajuan') }}">
            ...
            <div class="form-group">
                    ...
                    <input type="date" name="tanggal_pengajuan" id="tanggal_pengajuan" value="<?php echo date('Y-m-d') ?>" class="form-control" readonly>
                    </select>
                </div>
        ...
        $.ajax({
            ...
            success: function(textStatus) {
                if (textStatus.length > 0) {
                    ...
                    $('#nama_barang').html('<option selected disable> -- data tidak di temukan -- </option>');
                }
            }
