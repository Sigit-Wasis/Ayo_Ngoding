            ...
            <div class="card-body">
                <div class="form-group">
                    <label for="nama_jenis_barang">Nama Jenis Barang</label>
                        <input type="text" class="form-control" value ="{{$editJenisBarang->nama_jenis_barang}}" id="nama_jenis_barang" name= "nama_jenis_barang" placeholder="Nama Jenis Barang">
                </div>
                <div class="form-group">
                    <label for="deskripsi">Deskripsi</label>
                        <input type="text" class="form-control" value =" {{$editJenisBarang->deskripsi}}" id="deskripsi" name= "deskripsi" placeholder="Deskripsi">
                </div>
            </div>
