    ...
    <section class="content">
        ...
        <div class="modal fade" id="exampleModalVendor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Catatan Ditolak Vendor</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <ul>
                                    @if ($pengajuan->keterangan_ditolak_ap)
                                    @foreach(json_decode($pengajuan->keterangan_ditolak_ap) as $tolak)
                                    <li>{{ $tolak }}</li>
                                    @endforeach
                                    @endif
                                </ul>
