...
<input type="text" class="form-control" value="{{ $editJenisBarang->nama_barang }}" id="nama_jenis_barang" name="nama_jenis_barang" placeholder="">
</div>
<div class="form-group">
<label for="deskripsi">Deskripsi Jenis Barang</label>
<input type="text" class="form-control" value="{{ $editJenisBarang->deskripsi }}" id="deskripsi" name="deskripsi" placeholder="">
</div>
