...
Route::group(['namespace' => 'App\Http\Controllers'], function () {
  Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/edit-pengajuan/{id}', 'Backend\Pengajuan_barangController@edit')->name('edit_pengajuan');
    Route::post('/update-pengajuan-barang/{id}', 'Backend\Pengajuan_barangController@update')->name('update_pengajuan_barang');
    ...
    Route::get('/terima-vendor/{id}', 'Backend\Pengajuan_barangController@terimavendor')->name('terima_vendor');
