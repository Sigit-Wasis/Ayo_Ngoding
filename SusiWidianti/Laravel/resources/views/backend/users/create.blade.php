        ...
        <form method="POST" action="{{ route('store_users') }}">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{old('alamat') }}" id="alamat" name="alamat" placeholder="">
                </div>
                <div class="form-group">
                    <label for="nomor_telepon">Nomor Telepon</label>
                    <input type="text" class="form-control" value="{{old('nomor_telepon') }}" id="nomor_telepon" name="nomor_telepon" placeholder="">
                </div>
                <div class="form-group">
